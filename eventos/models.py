...
class Evento(models.Model):
    ...
    horaInicio = models.CharField("Hora de inicio", max_length=10, null=False, blank=False)
    horaFin = models.CharField("Hora de finalizacion", max_length=10, null=False, blank=False)
